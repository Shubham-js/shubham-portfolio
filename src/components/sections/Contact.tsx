...
const ICONS: Record<string, React.ReactNode> = {
  ...
  linkedin: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 1 1 2.063-2.063 2.062 2.062 0 0 1-2.063 2.063zm1.782 13.019H3.555V9h3.564v11.452z" />
    </svg>
  ),
  github: (
    <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <section className={styles.section} id="contact">
      <div className={`${styles.inner} reveal`}>
        ...
        <h2 className="secTitle">
          Let&apos;s build
          <br />
          <em>something</em> <strong>great</strong>.
        </h2>

        <a href="mailto:shubhamcomputer33@gmail.com" className={styles.email}>
          shubhamcomputer33@gmail.com
        </a>
        ...
        <div className={styles.links}>
          {SOCIAL_LINKS.map((l) => (
            ...
            >
              <span className={styles.linkIcon}>{ICONS[l.icon]}</span>
              {l.label}
            </a>
          ))}
        </div>
